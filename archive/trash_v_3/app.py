...
def _mjpeg_generator(cam: CameraPipeline):
    ...
    placeholder = _make_placeholder(cam.name)
    while True:
        try:
...
def _load_model_global(model_path: str, threshold: float) -> None:
    global _model, _class_names, _device, _threshold
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model",     default="C:\\Users\\thath\OneDrive - University of Bradford\Industrial AI Project\\trash\\trash\\trash_v_3\\models\\best_model.pth", help="Path to MobileNetV3 checkpoint")
