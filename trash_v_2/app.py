...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model",     default="C:\\Users\\thath\\OneDrive - University of Bradford\\Industrial AI Project\\trash\\trash\\trash_v_2\\best_model.pth", help="Path to MobileNetV3 checkpoint")
