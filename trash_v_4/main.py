...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--video",     type=str,   default="C:/Users/thath/OneDrive - University of Bradford/Industrial AI Project/trash/trash/trash_v_4/videos/video.mp4", help="Path to input video.")
    parser.add_argument("--model",     type=str,   default="C:/Users/thath/OneDrive - University of Bradford/Industrial AI Project/trash/trash/trash_v_4/models/best_model.pth",   help="Path to model checkpoint.")
